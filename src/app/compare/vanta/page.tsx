...
export const metadata = {
  ...
  description: 'Compare VaultFill\'s AI-powered, document-native compliance automation with Vanta\'s integration-heavy approach. See which solution fits your security team better.',
};
